...
public class Biznes_Web_11132
{
    ...
    public void Biznes_11132()
    {
        ...
        using (IWebDriver driver = new EdgeDriver(options))
        {
            ...
            try
            {
                ...
                driver.FindElement(By.Id("ServiceCode")).SendKeys("11132");
                ...
                IWebElement EmriSubjektit = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("subjectName")));
                ...
                IWebElement StatusiSubjektit = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("subjectStatus")));
    ...
    ExpectedConditions.ElementExists(
        By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/button[2]"))
                ...
                IWebElement docErrorMessage = wait.Until(
                    ExpectedConditions.ElementIsVisible(
                        By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div[2]/div[3]/div[2]"))
                );
                ...
                string fileVetedeklarim = @"C:\Users\Kreatx\Downloads\15mb.pdf";
                string fileKontrata = @"C:\Users\Kreatx\Downloads\Historic Serial PDA Report.xlsx";
                ...
                var wrongFileInputs = wait.Until(d =>
                {
                    ...
                    return els.Count >= 4 ? els : null;
                });

                wrongFileInputs[0].SendKeys(fileCV);
                wrongFileInputs[1].SendKeys(fileDocTeknik);
                wrongFileInputs[2].SendKeys(fileVetedeklarim);
                wrongFileInputs[3].SendKeys(fileKontrata);
                ...
                string correctFileDocTeknik = @"C:\Users\Kreatx\Downloads\TEST.pdf";
                string correctFileVetedeklarimi = @"C:\Users\Kreatx\Downloads\TEST.pdf";
                string correctFileKontrata = @"C:\Users\Kreatx\Downloads\TEST.pdf";
                ...
                correctFileInputs[0].SendKeys(correctFileCV);
                correctFileInputs[1].SendKeys(correctFileDocTeknik);
                correctFileInputs[2].SendKeys(correctFileVetedeklarimi);
                correctFileInputs[3].SendKeys(correctFileKontrata);

                Thread.Sleep(1500);

                Log("Verify uploaded docs are present");
                Assert.That(correctFileInputs[0].GetAttribute("value"), Is.Not.Empty, "File CV u ngarkua por inputi është bosh.");
                Assert.That(correctFileInputs[1].GetAttribute("value"), Is.Not.Empty, "File Doc Teknik u ngarkua por inputi është bosh.");
                Assert.That(correctFileInputs[2].GetAttribute("value"), Does.Contain(".pdf"));
                Assert.That(correctFileInputs[3].GetAttribute("value"), Does.Contain(".pdf"));
                ...
                Log("Click 'checkbox' button");
                IWebElement checkbox = wait.Until(
    ExpectedConditions.ElementExists(By.Id("agreeCheck"))
);
                ...
                // Kliko direkt me JS, pa pritur ElementToBeClickable
                ((IJavaScriptExecutor)driver).ExecuteScript("arguments[0].click();", checkbox);

                Thread.Sleep(500);

                // verifiko qe checkbox u selektua
                Assert.That(checkbox.Selected || checkbox.GetAttribute("checked") != null, Is.True,
                    "Checkbox nuk u selektua.");

                driver.FindElement(By.XPath("//button[contains(normalize-space(),'Dërgo')]")).Click();
                ...
                Log("Assert that in success page is GjurmoBtn, PaguajOnlline");
                IWebElement gjurmoBtn = wait.Until(
                    ExpectedConditions.ElementIsVisible(
                        By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[1]/div/div/div/div/button"))
                );
                Assert.That(gjurmoBtn.Displayed, Is.True);

                IWebElement PayOnline = wait.Until(
                    ExpectedConditions.ElementIsVisible(
                        By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div/div/button"))
                );
    ...
    gjurmoBtn
                ...
                {
                    wait.Until(ExpectedConditions.ElementToBeClickable(
                        By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[1]/div/div/div/div/button"))).Click();
                }
