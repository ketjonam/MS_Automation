...
{
    [Test]
    public void KryejAplikimMobile()
    {
        ...
        using (IWebDriver driver = new EdgeDriver(options))
        {
            ...
            IWebElement NderfaqaPensionetElement = driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div[2]/div/div[2]/div/div[2]/div[2]/input"));
    ...
    SeleniumExtras.WaitHelpers.ExpectedConditions.ElementToBeClickable(
        By.XPath("//input[@placeholder='Kërko' and contains(@class,'form-control')]")));
            ...
            var emptyMessageCell = wait.Until(
                SeleniumExtras.WaitHelpers.ExpectedConditions.ElementIsVisible(
                    By.XPath("/html/body/div/main/div[3]/div/div/div[2]/div/div[2]/div/div[3]/table/tbody/tr/td")));
    ...
    SeleniumExtras.WaitHelpers.ExpectedConditions.ElementToBeClickable(
        By.XPath("//input[@placeholder='Kërko' and contains(@class,'form-control')]")));
            kerkofilter2.Clear();
            kerkofilter2.SendKeys("20091");

            Thread.Sleep(1000);

            // Merr të gjithë rreshtat që përmbajnë "20091"
var matchingRows = driver.FindElements(
    By.XPath("//table/tbody/tr[td[contains(text(),'20091')]]"));

            // Assert 1 – Duhet të ketë të paktën një rresht me "20091"
            Assert.That(matchingRows.Count, Is.GreaterThan(0),
                "Nuk u gjet asnjë rresht që përmban '20091' pas filtrimit.");
