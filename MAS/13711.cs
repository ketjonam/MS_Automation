...
public class _13711_
{
    ...
    [Test]
    public void TrasferimiNxenesveNeGjimnaz()
    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("13711");
        ...
        IWebElement NID = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/form/div/div[1]/input")));
        Assert.That(NID.GetAttribute("value").Trim(), Is.EqualTo("I35915047A"));
        IWebElement Emri = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/form/div/div[2]/input")));
        Assert.That(Emri.GetAttribute("value").Trim(), Is.EqualTo("Viola"));
        IWebElement Mbiemri = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/form/div/div[3]/input")));
        Assert.That(Mbiemri.GetAttribute("value").Trim(), Is.EqualTo("Sterjo"));
        IWebElement Datelindja = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/form/div/div[6]/input")));
        Assert.That(Datelindja.GetAttribute("value").Trim(), Is.EqualTo("15.09.1983"));
        IWebElement Email = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/form/div/div[7]/input")));
        Assert.That(Email.GetAttribute("value").Trim(), Is.EqualTo("ketjona.mema@kreatx.com"));
        IWebElement Tel = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/form/div/div[4]/input")));
        ...
        Assert.That(msgError.Text.Trim(), Is.EqualTo("Plotesoni fushën për të vazhduar"));
        ...
        IWebElement popupContainer = wait.Until(ExpectedConditions.ElementIsVisible(
            By.CssSelector("div.alert-modal-container")
        ));
        Assert.That(popupContainer.Displayed, Is.True);

        IWebElement popupTitle = wait.Until(ExpectedConditions.ElementIsVisible(
            By.CssSelector("h2.alert-modal-title")
        ));
        Assert.That(popupTitle.Text.Trim(), Is.EqualTo("Kujdes"));

        IWebElement popupDescription = wait.Until(ExpectedConditions.ElementIsVisible(
            By.CssSelector("div.alert-modal-description")
        ));
        Assert.That(
            popupDescription.Text.Trim(),
            Is.EqualTo("Ky numër identiteti nuk përmbush kriteret për tu transferuar në gjimnaz!")
        );

        IWebElement popupButton = wait.Until(ExpectedConditions.ElementIsVisible(
            By.CssSelector("button.alert-modal-button.alert-modal-button--primary")
        ));
        Assert.That(popupButton.Text.Trim(), Is.EqualTo("OK"));

        Log("Kliko OK ne Popup Kujdes");
