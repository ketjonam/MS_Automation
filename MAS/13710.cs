...
public class _13710_
{
    ...
    [Test]
    public void TrasferimiNxenesve()
    {
        ...
        Log("Fill form");
        driver.FindElement(By.Id("Nid")).SendKeys("I35915047A");
        driver.FindElement(By.Id("ServiceCode")).SendKeys("13710");
        driver.FindElement(By.Id("MicroserviceName")).SendKeys("mas-merge");
        ...
        Assert.That(NID.GetAttribute("value").Trim(), Is.EqualTo("I35915047A"));
        ...
        Assert.That(Emri.GetAttribute("value").Trim(), Is.EqualTo("Viola"));
        ...
        Assert.That(Mbiemri.GetAttribute("value").Trim(), Is.EqualTo("Sterjo"));
        ...
        Assert.That(Datelindja.GetAttribute("value").Trim(), Is.EqualTo("15.09.1983"));
        IWebElement Email = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[7]/input")));
        Assert.That(Email.GetAttribute("value").Trim(), Is.EqualTo("ketjona.mema@kreatx.com"));
        IWebElement Tel = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[4]/input")));
        ...
        Log("Kliko vazhdo button pa zgjedhur gjimnazin");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/button[2]"));

        Log("Assert mesazhin per fushat e detyrueshme");
        IWebElement msgError = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[1]/span")));
        Assert.That(msgError.Text.Trim(), Is.EqualTo("Përzgjidhni një vlerë për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        new SelectElement(wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[1]/select")))).SelectByValue("Familjar");
        Thread.Sleep(3000);

        new SelectElement(wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[2]/select")))).SelectByValue("L61213022F");
        Thread.Sleep(500);

        Log("Assert te dhenat e femijes");
        IWebElement EmriFemije = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[3]/input")));
        Assert.That(EmriFemije.GetAttribute("value").Trim(), Is.EqualTo("Gabriel"));
        IWebElement MbiemriFemije = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[4]/input")));
        Assert.That(MbiemriFemije.GetAttribute("value").Trim(), Is.EqualTo("Kepi"));
        IWebElement DatelindjaFemije = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[6]/input")));
        Assert.That(DatelindjaFemije.GetAttribute("value").Trim(), Is.EqualTo("13/12/2016"));
        IWebElement AtesiaFemije = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[5]/input")));
        Assert.That(AtesiaFemije.GetAttribute("value").Trim(), Is.EqualTo("Fatmir"));
        ...
        Assert.That(Step3Title.Text.Trim(), Is.EqualTo("INFORMACION MBI TRANSFERIMIN"));

        Log("Kliko Dergo button pa plotesuar fushat e detyrueshme");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/button[2]"));

        Log("Assert mesazhin per fushat e detyrueshme");
        IWebElement msgReqField = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[1]/div[3]/span")));
        Assert.That(msgReqField.Text.Trim(), Is.EqualTo("Përzgjidhni një vlerë për të vazhduar"));

        Log("Ploteso detyrueshme");
        new SelectElement(wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[1]/div[2]/select")))).SelectByValue("transferimMesVitit");
