...
public class _10090_
{
    ...
    public void RipajisjeDAP()
    {
        ...
        IWebElement Step1Title = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div/div/div[1]/div/h4")));
        Assert.That(Step1Title.Text.Trim(), Is.EqualTo("KËRKOJ TË RINOVOJ DAP-IN QË DISPONOJ PËR:*"));

        Log("Kliko Vazhdo pa zgjedhur llojin e DAP");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/button[2]"));

        Log("Assert error message per moszgjedhjen e llojit te DAP");
        ...
        IWebElement msgError = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div/div/div[3]")));
