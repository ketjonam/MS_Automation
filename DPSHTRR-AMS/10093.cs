...
public class _10093_
{
    ...
    public void RipajisjeDAPperMakineriteeRenda()
    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("10093");
        ...
        IWebElement Tel = wait.Until(ExpectedConditions.ElementIsVisible(By.Name("telNo")));
        ...
        Log("Kliko Vazhdo button pa zgjedhur DPSHTRR");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/button[2]"));

        Log("Assert error message per DPSHTRR");
        IWebElement msgErrorDPSHTRR = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[3]/div")));
        Assert.That(msgErrorDPSHTRR.Text.Trim(), Is.EqualTo("Përzgjidhni një vlerë për të vazhduar"));

        Log("Zgjidh DPSHTRR");
        new SelectElement(wait.Until(ExpectedConditions.ElementIsVisible(By.Name("rajoni")))).SelectByValue("346f9d39-16dd-4000-a53d-b8b49a30d210");
        ...
        Assert.That(Step3Title.Text.Trim(), Is.EqualTo("LLOJI I DAP"));

        Log("Kliko Vazhdo button pa zgjedhur llojin e DAP");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/button[2]"));

        Log("Assert error message per llojin e DAP");
        IWebElement msgErrorDAP = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div/div[2]")));
        Assert.That(msgErrorDAP.Text.Trim(), Is.EqualTo("Përzgjidhni një vlerë për të vazhduar"));

        Log("Zgjidh llojin e DAP");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div/div[1]/div/div/div/div[1]/div/input"));
        ...
        Log("Kliko Dergo buton pa zgjedhur arsyjen e kerkeses");
        SafeClick(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/div[3]/button[2]"));


        IWebElement msgError = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/div[2]/div/div/div/div[3]")));
        Assert.That(msgError.Text.Trim(), Is.EqualTo("Përzgjidhni një vlerë për të vazhduar"));

        Log("Zgjidh arsyen kerkeses");
        SafeClick(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/div[2]/div/div/div/div[2]/div[1]/input"));

        Log("Ngarko dok jo te sakte");

        string DAP = @"C:\Users\Kreatx\Downloads\Kthim Alfis test(1).pdf";

        Assert.That(File.Exists(DAP), Is.True, "File DAP nuk ekziston.");

        IWebElement DAPInputWrong = wait.Until(
            ExpectedConditions.ElementExists(
                By.XPath("//div[contains(.,'DAP-i që dispononi*')]/following::input[@type='file'][1]"))
        );
        DAPInputWrong.SendKeys(DAP);
