...
public class _10114_
{
...

    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("10114");
        ...
        IWebElement NrIdentifikimit = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div/div[1]/input")));
        ...
        IWebElement Qyteti = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[1]/div[5]/input")));
        Assert.That(Qyteti.GetAttribute("value").Trim(), Is.EqualTo("TIRANË"));

        IWebElement Rrethi = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[1]/div[4]/input")));
        Assert.That(Rrethi.GetAttribute("value").Trim(), Is.EqualTo("KAVAJË"));

        IWebElement Tel = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[1]/div[1]/input")));
        ...
        IWebElement msgErrorMsg = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div[5]/div/span")));
