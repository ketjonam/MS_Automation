...
public class _10112_FailCase_
{
    ...
    public void Rrimarrje_Leje_Drejtimi_FailCase_ReturnsUiMessage()
    {
        ...
        Log("Plotëso fushat e detyrueshme me motivi unik");
        new SelectElement(driver.FindElement(By.Name("arsyejaAplikimit"))).SelectByValue("Zerim pikësh");
        string uniqueMotivi = "FAIL12_" + DateTime.Now.ToString("yyyyMMddHHmmss");
        Log($"motiviKerkeses unik për stimulim FAIL: {uniqueMotivi}");
