...
public class _10094_
{
    ...
    public void Regjistrim_Mjeti()
    {
        ...
        driver.FindElement(By.Name("vin")).SendKeys("testautomation");
        driver.FindElement(By.Name("licenceNo")).SendKeys("test1");
        new SelectElement(driver.FindElement(By.Name("vehicleType"))).SelectByValue("MT");
