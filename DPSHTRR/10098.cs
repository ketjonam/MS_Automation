...
public class _10098
{
    ...
    public void Aplikim_Per_Nderrim_LejeQarkullimi()
    {
        ...
        Assert.That(NrTel.GetAttribute("value").Trim(), Is.EqualTo("ketjona.mema@kreatx.com"));
        ...
        new SelectElement(driver.FindElement(By.Name("vehicleType"))).SelectByText("Automjete dhe makina");
