...
public class _10100
{
    ...
    public void Ndrimm_Pronesie()
    {
        ...
        IWebElement Email = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[8]/input")));
        Assert.That(Email.GetAttribute("value").Trim(), Is.EqualTo("ketjona.mema@kreatx.com"));

        IWebElement NrTel = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[9]/input")));
        ...
        driver.FindElement(By.Name("txtVin")).SendKeys("WAUZZZ4G4EN070522");
        driver.FindElement(By.Name("txtLicenceNo")).SendKeys("AB770PP");
        new SelectElement(driver.FindElement(By.Name("ddVehicleType"))).SelectByValue("M");
        new SelectElement(driver.FindElement(By.Name("ddServiceBundle"))).SelectByValue("NP");
        ...
        IWebElement checkbox = wait.Until(ExpectedConditions.ElementExists(By.Id("confirmAdminDocuments")));
