...
public class _9765_
{
    ...
    [Test]
    public void AplikimPerIDPassaporte()
    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("9765");
        ...
        IWebElement step1Title = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div/h4")));
        ...
        IWebElement Amesia = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("motherName")));
        Assert.That(Amesia.GetAttribute("value").Trim(), Is.EqualTo("Aishe"));
        ...
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div/div[2]/div/button[2]"));

        Log("Assert mesazhin per fushat e detyrueshme");
        IWebElement msgError = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div/form/div[1]/div[1]/div/p")));
        Assert.That(msgError.Text.Trim(), Is.EqualTo("Përzgjidhni një vlerë për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.Id("type"))).SelectByValue("13");
        ...
        IWebElement Step2Title = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div/h4")));
        ...
        IWebElement msgErrorReqField = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div/form/div/div[2]/div[1]/div/p")));
        ...
        IWebElement Step3Title = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div/h4")));
        ...
        Log("Assert mesazhin e errorit per fushat e detyrueshme");
        IWebElement msgErrorContact = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div/form/div[1]/div[3]/p")));
        ...
        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.Name("country"))).SelectByValue("Turqia");
        Thread.Sleep(500);
        new SelectElement(driver.FindElement(By.Id("consulate"))).SelectByValue("44");
        ...
        IWebElement Step4Title = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/div/h4")));
        Assert.That(Step4Title.Text.Trim(), Is.EqualTo("REZERVONI ORARIN"));

        Log("Kliko Vazhdo button pa plotesuar fushat e detyrueshme");
        SafeClick(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/div/div[2]/div/button[2]"));

        Log("Assert mesazhin e errorit per fushat e detyrueshme");
        IWebElement msgErrorRequest = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/div/form/div[1]/div[2]/div")));
        Assert.That(msgErrorRequest.Text.Trim(), Is.EqualTo("Plotësoni fushën për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        driver.FindElement(By.Id("fromDate")).SendKeys("29.04.2026");
        driver.FindElement(By.Id("toDate")).SendKeys("15.05.2026");

        Log("Kliko butonin Shfaq oraret e lira");
        SafeClick(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/div/form/div[2]/div/button"));

        Thread.Sleep(2000);

        Log("Zgjidh daten dhe oren");
        new SelectElement(driver.FindElement(By.Id("selectDate"))).SelectByValue("05.05.2026");
        Thread.Sleep(500);
        new SelectElement(driver.FindElement(By.Id("selectTime"))).SelectByValue("10:00:00 - 11:00:00");
        ...
        IWebElement msgErrorDocs = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div[1]/div[2]/div/div/div[2]")));
        ...
        Assert.That(File.Exists(ID), Is.True, "File NID nuk ekziston.");
        ...
        ID = @"C:\Users\Kreatx\Downloads\Signed_TEST_signed.pdf";
