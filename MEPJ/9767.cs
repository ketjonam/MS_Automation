...
public class _9767_
{
    ...
    public void RegjistrimFemije()
    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("9767");
        ...
        IWebElement msgErrorReqField = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[2]/div")));
        Assert.That(msgErrorReqField.Text.Trim(), Is.EqualTo("Plotësoni fushën për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.Name("shtetiAdresa"))).SelectByValue("2");
        driver.FindElement(By.Id("city")).SendKeys("test");
        driver.FindElement(By.Id("streetAndHouseNumber")).SendKeys("test");
        ...
        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.Name("shtetiKontakti"))).SelectByValue("2");
        Thread.Sleep(500);
        new SelectElement(driver.FindElement(By.Name("consulate"))).SelectByValue("1");
        ...
        Assert.That(Step4Title.Text.Trim(), Is.EqualTo("TË DHËNAT E FËMIJËS PËR REGJISTRIM"));

        Log("Kliko Vazhdo button pa plotesuar fushat e detyrueshme");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/button[2]"));

        Log("Assert mesazhin e errorit per fushat e detyrueshme");
        IWebElement msgErrorRequest = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[3]/div")));
        Assert.That(msgErrorRequest.Text.Trim(), Is.EqualTo("Plotësoni fushën për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        IWebElement dateInput = wait.Until(
          ExpectedConditions.ElementToBeClickable(By.XPath("//input[@placeholder='dd.mm.yyyy']"))
      );
        dateInput.SendKeys("01.01.2020");
        driver.FindElement(By.Id("child_firstName")).SendKeys("Test");
        driver.FindElement(By.Id("child_birthCity")).SendKeys("Test");
        new SelectElement(driver.FindElement(By.Id("child_birthCountry"))).SelectByValue("1");
        new SelectElement(driver.FindElement(By.Id("child_gender"))).SelectByValue("0");
        driver.FindElement(By.Id("child_fatherName")).SendKeys("test");
        driver.FindElement(By.Id("child_lastName")).SendKeys("test");
        driver.FindElement(By.Id("child_motherName")).SendKeys("test");
        driver.FindElement(By.Id("child_civilRegistryOffice")).SendKeys("test");
        Log("Kliko Vazhdo button");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/button[2]"));
    ...
    By.XPath("//h2[contains(text(),'Dokumentacioni')]")
));
        ...
        IWebElement msgErrorDocs = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div[1]/div[2]/div[2]")));
        Assert.That(msgErrorDocs.Text.Trim(), Is.EqualTo("Ju lutem ngarkoni dokumentin e kërkuar."));


        Log("Ngarko dokument jo te sakte");
        string AktiLindjes = @"C:\Users\Kreatx\Downloads\Kthim Alfis test(1).pdf";
        string IDPrindi = @"C:\Users\Kreatx\Downloads\Test_Automation_NIPTWEB_Prezantim.pptx";
        string CertifikatLindje = @"C:\Users\Kreatx\Downloads\E88.30_CheckPointVPN.msi";


        Assert.That(File.Exists(AktiLindjes), Is.True, "File Akti Lindjes nuk ekziston.");
        Assert.That(File.Exists(IDPrindi), Is.True, "File ID Prindi nuk ekziston.");
        Assert.That(File.Exists(CertifikatLindje), Is.True, "File Certifikat Lindje nuk ekziston.");

        IWebElement AktiLindjesInputWrong = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Akti i lindjes së fëmijës')]/following::input[@type='file'][1]"))
        );
        AktiLindjesInputWrong.SendKeys(AktiLindjes);

        IWebElement IDPrindiInputWrong = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokumente identifikimi të Prindërve')]/following::input[@type='file'][1]"))
        );
        IDPrindiInputWrong.SendKeys(IDPrindi);

        IWebElement CertifikateLindjeInputWrong = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'certifikatës së lindjes,')]/following::input[@type='file'][1]"))
        );
        CertifikateLindjeInputWrong.SendKeys(CertifikatLindje);
        ...
        AktiLindjes = @"C:\Users\Kreatx\Downloads\Signed_TEST_signed.pdf";
        IDPrindi = @"C:\Users\Kreatx\Downloads\Signed_TEST_signed.pdf";
        CertifikatLindje = @"C:\Users\Kreatx\Downloads\Signed_TEST_signed.pdf";

        Assert.That(File.Exists(AktiLindjes), Is.True, "File Akti lindjes nuk ekziston.");
        Assert.That(File.Exists(IDPrindi), Is.True, "File ID Prindi nuk ekziston.");
        Assert.That(File.Exists(CertifikatLindje), Is.True, "File Certifikat Lindje nuk ekziston.");

        IWebElement AktiLindjesInput = wait.Until(
         ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Akti i lindjes së fëmijës')]/following::input[@type='file'][1]"))
       );
        AktiLindjesInput.SendKeys(AktiLindjes);

        IWebElement IDPrindiInput = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokumente identifikimi të Prindërve')]/following::input[@type='file'][1]"))
        );
        IDPrindiInput.SendKeys(IDPrindi);

        IWebElement CertifikatLindjeInput = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'certifikatës së lindjes,')]/following::input[@type='file'][1]"))
        );
        CertifikatLindjeInput.SendKeys(CertifikatLindje);
