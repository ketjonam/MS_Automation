...
public class _9774_
{
    ...
    public void PerkthimDokumenti()
    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("9774");
        ...
        IWebElement msgError = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[7]/span")));
        ...
        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.Id("shteti"))).SelectByValue("2");
        ...
        IWebElement Tel = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("telNo")));
        Assert.That(Tel.GetAttribute("value").Trim(), Is.EqualTo("0676041404"));

        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.Id("shteti"))).SelectByValue("2");
        Thread.Sleep(500);
        new SelectElement(driver.FindElement(By.Id("zyraKonsullore"))).SelectByValue("1");
        ...
        Assert.That(Step4Title.Text.Trim(), Is.EqualTo("KËRKESA PËR PËRKTHIMIN E DOKUMENTIT*"));

        Log("Kliko Vazhdo button pa plotesuar fushat e detyrueshme");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/button[2]"));

        Log("Assert mesazhin e errorit per fushat e detyrueshme");
        IWebElement msgErrorHsb = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div[1]/div/span")));
        Assert.That(msgErrorHsb.Text.Trim(), Is.EqualTo("Plotësoni fushën për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        driver.FindElement(By.Id("caseDetails")).SendKeys("test");
        new SelectElement(driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div[2]/div[1]/select"))).SelectByValue("2");
        new SelectElement(driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div[2]/div[2]/select"))).SelectByValue("3");
        ...
        IWebElement DokumentiInputWrong = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokumenti që do të përkthehet')]/following::input[@type='file'][1]"))
        );
