...
public class _9780_
{
    ...
    [Test]
    public void NjehesimiiKopjesMeOrigjinalin()
    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("9780");
        ...
        IWebElement msgErrorReqField = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[4]/span")));
        ...
        Assert.That(msgErrorContact.Text.Trim(), Is.EqualTo("Përzgjidh fushën për të vazhduar"));
        ...
        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.Name("country"))).SelectByValue("2");
        Thread.Sleep(500);
        ...
        Assert.That(Step4Title.Text.Trim(), Is.EqualTo("KËRKESA PËR NJËSIMIN E KOPJES ME ORIGJINALIN*"));
        ...
        Log("Ploteso fushat e detyrueshme");
        driver.FindElement(By.Id("kerkesaTextArea")).SendKeys("test");
        ...
        IWebElement DokumentiInputWrong = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokumenti origjinal')]/following::input[@type='file'][1]"))
        );
