...
public class _9778_
{
    ...
    public void LidhjeMarteseMeShtetasTeHuaj()
    {
        ...
        IWebElement msgErrorDocs = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div[1]/div[4]/div[2]")));
        Assert.That(msgErrorDocs.Text.Trim(), Is.EqualTo("Ju lutem ngarkoni dokumentin e kërkuar"));

        Log("Ngarko dokument jo te sakte");
        string DokumentIDWife = @"C:\Users\Kreatx\Downloads\Kthim Alfis test(1).pdf";
        ...
        Assert.That(File.Exists(DokumentIDWife), Is.True, "File DokumentIDWife nuk ekziston.");
        ...
        IWebElement DokumentIDWifeInputWrong = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokument identifikimi')]/following::input[@type='file'][1]"))
        );
        DokumentIDWifeInputWrong.SendKeys(DokumentIDWife);
        ...
        IWebElement IDDeshmitareveInputWrong = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokument i vlefshëm identifikimi për secilin dëshmitar')]/following::input[@type='file'][1]"))
        );
        ...
        DokumentIDWife = @"C:\Users\Kreatx\Downloads\Signed_TEST_signed.pdf";
        ...
        string DokumentIDHsb = @"C:\Users\Kreatx\Downloads\Signed_TEST_signed.pdf";

        Assert.That(File.Exists(DokumentIDWife), Is.True, "File Dokument ID nuk ekziston.");
        Assert.That(File.Exists(LejeQendrimi), Is.True, "File Leje Qëndrimi nuk ekziston.");
        Assert.That(File.Exists(IDDeshmitareve), Is.True, "File ID Deshmitareve nuk ekziston.");

        IWebElement DokumentIDWifeInput = wait.Until(
         ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokument identifikimi')]/following::input[@type='file'][1]"))
       );
        DokumentIDWifeInput.SendKeys(DokumentIDWife);
        ...
        IWebElement DokumentIDHsbInput = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokument për shtetasin/en e huaj që lejon martesën')]/following::input[@type='file'][1]"))
        );
        DokumentIDHsbInput.SendKeys(DokumentIDHsb);
