...
/// <summary>
/// Stimulon rastin e FAIL të 10094: të njëjtat të dhëna, por pa ngarkuar dokumente,
/// që pas Dërgo të mos shfaqet as sukses as "Kujdes". Testi dështon me mesazhin e UI.
/// </summary>
[TestFixture]
public class _10094_FailCase_
{
    ...
    /// <summary>
    /// Mbledh mesazhin e dukshëm pas Dërgo (error, modal, toast, ose tekst në main/#root).
    /// </summary>
    ...
    [Test]
    public void Regjistrim_Mjeti_FailCase_ReturnsUiMessage()
    {
        ...
        Log("Fill form (të njëjtat të dhëna si 10094)");
        driver.FindElement(By.Id("Nid")).SendKeys("J25730113W");
        driver.FindElement(By.Id("ServiceCode")).SendKeys("10094");
        ...
        // VIN/licence unik që të mos shfaqet modal 'Kujdes' — stimulojmë FAIL pa dokumente
        string uniqueVin = "FAIL94" + DateTime.Now.ToString("yyyyMMddHHmmss");
        string uniqueLicence = "LIC94" + DateTime.Now.ToString("HHmmss");
        ...
        SelectByValueSafe(By.Name("vehicleType"), "MT");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/button[2]"));
        ...
        DpshtrrFailCaseSupport.ClickConsentCheckboxIfPresent(driver, Log, "agreeCheck");
    ...
    [Test]
    public void Regjistrim_Mjeti_FailCase_GjendjaCivile_ReturnsGabimPopup()
    {
        ...
        Log($"Fill form (10094, NID {expectedNid} për stimulim Gabim nga Gjendja Civile)");
    ...
    [Test]
    public void Regjistrim_Mjeti_FailCase_Qkb_ReturnsGabimPopup()
    {
        ...
        Log($"Fill form (10094, NID {expectedNid}, ProfileType Organisation për stimulim Gabim nga QKB)");
        driver.FindElement(By.Id("Nid")).SendKeys(expectedNid);
        driver.FindElement(By.Id("ServiceCode")).SendKeys("10094");
        driver.FindElement(By.Id("MicroserviceName")).SendKeys("dpshtrr-merge-not-ams_refactor");
        driver.FindElement(By.Id("UserName")).SendKeys("Ketjona");
