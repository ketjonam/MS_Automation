...
public class _10092_FailCase_
{
    ...
    [Test]
    public void Regjistrim_Ciklomotori_FailCase_ReturnsUiMessage()
    {
        ...
        Log("Fill form (të njëjtat të dhëna si 10092)");
        ...
        string uniqueVin = "FAIL" + DateTime.Now.ToString("yyyyMMddHHmmss");
        string uniqueLicence = "LIC" + DateTime.Now.ToString("HHmmss");
        ...
        DpshtrrFailCaseSupport.ClickConsentCheckboxIfPresent(driver, Log, "consentCheckbox");
    ...
    [Test]
    public void Regjistrim_Ciklomotori_FailCase_GjendjaCivile_ReturnsGabimPopup()
    {
        const string expectedNid = "J55728107H";
        const string expectedTitle = "Gabim";
        ...
        Log($"Fill form (10092, NID {expectedNid} për stimulim Gabim nga Gjendja Civile)");
        ...
        DpshtrrFailCaseSupport.AssertExpectedGabimPopup(
            ...
            expectedSourceLabel: "Gjendja Civile");
    }

    [Test]
    public void Regjistrim_Ciklomotori_FailCase_Qkb_ReturnsGabimPopup()
    {
        ...
        Log($"Fill form (10092, NID {expectedNid}, ProfileType Organisation për stimulim Gabim nga QKB)");
        driver.FindElement(By.Id("Nid")).SendKeys(expectedNid);
        driver.FindElement(By.Id("ServiceCode")).SendKeys("10092");
        driver.FindElement(By.Id("MicroserviceName")).SendKeys("dpshtrr-merge-not-ams_refactor");
        driver.FindElement(By.Id("UserName")).SendKeys("Ketjona");
        ...
        DpshtrrFailCaseSupport.AssertExpectedGabimPopup(
            ...
            expectedTitle: "Gabim",
            expectedDescription: expectedDescription,
            expectedSourceLabel: "Qendra Kombëtare e Biznesit");
    }
}
