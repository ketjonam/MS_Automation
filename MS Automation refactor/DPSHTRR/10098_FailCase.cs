...
/// <summary>
/// Stimulon rastin e FAIL të 10098: të njëjtat të dhëna, por pa ngarkuar dokumente,
/// që pas Dërgo të mos shfaqet as sukses as "Kujdes". Testi dështon me mesazhin e UI.
/// </summary>
[TestFixture]
public class _10098_FailCase_
{
    ...
    public void Aplikim_Per_Nderrim_LejeQarkullimi_FailCase_ReturnsUiMessage()
    {
        ...
        Log("Fill form (të njëjtat të dhëna si 10098)");
    ...
    [Test]
    public void Aplikim_Per_Nderrim_LejeQarkullimi_FailCase_GjendjaCivile_ReturnsGabimPopup()
    {
        ...
        Log($"Fill form (10098, NID {expectedNid} për stimulim Gabim nga Gjendja Civile)");
    ...
    [Test]
    public void Aplikim_Per_Nderrim_LejeQarkullimi_FailCase_Qkb_ReturnsGabimPopup()
    {
        ...
        Log($"Fill form (10098, NID {expectedNid}, ProfileType Organisation për stimulim Gabim nga QKB)");
        driver.FindElement(By.Id("Nid")).SendKeys(expectedNid);
        driver.FindElement(By.Id("ServiceCode")).SendKeys("10098");
        driver.FindElement(By.Id("MicroserviceName")).SendKeys("dpshtrr-merge-not-ams_refactor");
        driver.FindElement(By.Id("UserName")).SendKeys("Ketjona");
