...
public class _39_NID
{
    ...
    public void AutomjeteteMia()
    {
        ...
        string filterInputXpath = "//input[@placeholder='Kërko']";
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("39");
        ...
        IWebElement noDataRow = wait.Until(d =>
        {
            try
            {
                ...
                return row.Text.Trim().Contains("Nuk dispononi mjete!") ? row : null;
            }
            catch
            {
                return null;
        ...
        Assert.That(noDataRow.Text.Trim(), Does.Contain("Nuk dispononi mjete!"),
            "Mesazhi 'Nuk dispononi mjete!' nuk u shfaq");
        ...
        IWebElement dataRow = wait.Until(d =>
        {
            try
            {
                ...
                if (rowText.Contains("Nuk dispononi mjete!"))
                    return null;
