...
/// <summary>
/// Stimulon rastin e FAIL të 10112: i njëjti rrjedhë deri në Step4, por pa ngarkuar dokumente,
/// që pas Dërgo të mos shfaqet as sukses as "Kujdes". Testi dështon me mesazhin e UI.
/// </summary>
[TestFixture]
public class _10112_FailCase_
{
    ...
    [Test]
    public void Rrimarrje_Leje_Drejtimi_FailCase_ReturnsUiMessage()
    {
        ...
        Log("Fill form (të njëjtat të dhëna si 10112)");
        driver.FindElement(By.Id("Nid")).SendKeys("J25730113W");
        driver.FindElement(By.Id("ServiceCode")).SendKeys("10112");
        ...
        Assert.That(
            wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div/div[1]/input"))).GetAttribute("value").Trim(),
            Is.EqualTo("J25730113W"));
        Assert.That(
            wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div/div[2]/input"))).GetAttribute("value").Trim(),
            Is.EqualTo("Daniela"));
        Assert.That(
            wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div/div[3]/input"))).GetAttribute("value").Trim(),
            Is.EqualTo("Mema"));
        Assert.That(
            wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div/div[4]/input"))).GetAttribute("value").Trim(),
            Is.EqualTo("Mersin"));
        Assert.That(
            wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div/div[5]/input"))).GetAttribute("value").Trim(),
            Is.EqualTo("30.07.1992"));
        ...
        Assert.That(
            wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[1]/div[2]/input"))).GetAttribute("value").Trim(),
            Is.EqualTo("ketjona.mema@kreatx.com"));
        Assert.That(
            wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[1]/div[1]/input"))).GetAttribute("value").Trim(),
            Is.EqualTo("0676041404"));
        Assert.That(
            wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[1]/div[5]/input"))).GetAttribute("value").Trim(),
            Is.EqualTo("KAVAJË"));
        Assert.That(
            wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[1]/div[6]/input"))).GetAttribute("value").Trim(),
            Is.EqualTo("TIRANË"));

        Log("Zgjidh DPSHTRR dhe vazhdo");
        new SelectElement(driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[1]/div[3]/select"))).SelectByValue("11");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/button[2]"));
        Thread.Sleep(3000);
        ...
        Assert.That(Step3Title.Text.Trim(), Is.EqualTo("KËRKESËS"));

        Log("STIMULIM FAIL: NUK plotësohen fushat e detyrueshme të hapit 'KËRKESËS' (as arsyeja, as motivi), " +
            "që aplikimi të MOS dërgohet dhe të kthehet mesazh gabimi (jo 'Kujdes', jo sukses).");
        Thread.Sleep(1000);

        Log("Kliko 'Dërgo/Vazhdo' pa plotësuar të dhënat e kërkesës");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/button[2]"));
        DpshtrrFailCaseSupport.AssertInformationalFailAfterDergo(driver, Log);
    }

    [Test]
    public void Rrimarrje_Leje_Drejtimi_FailCase_GjendjaCivile_ReturnsGabimPopup()
    {
        ...
        Log($"Fill form (10112, NID {expectedNid} për stimulim Gabim nga Gjendja Civile)");
    ...
    [Test]
    public void Rrimarrje_Leje_Drejtimi_FailCase_Qkb_ReturnsGabimPopup()
    {
        ...
        Log($"Fill form (10112, NID {expectedNid}, ProfileType Organisation për stimulim Gabim nga QKB)");
        driver.FindElement(By.Id("Nid")).SendKeys(expectedNid);
        driver.FindElement(By.Id("ServiceCode")).SendKeys("10112");
        driver.FindElement(By.Id("MicroserviceName")).SendKeys("dpshtrr-merge-not-ams_refactor");
        driver.FindElement(By.Id("UserName")).SendKeys("Ketjona");
