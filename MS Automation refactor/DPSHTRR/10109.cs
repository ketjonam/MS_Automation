...
public class _10109_
{
    ...
    public void Ndryshim_Gjeneralitetesh()
    {
        ...
        IWebElement errorMessage = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[2]/div")));
        Assert.That(errorMessage.Text.Trim(), Is.EqualTo("Plotësoni fushën për të vazhduar"));

        Log("Plotëso fushat e kërkuara dhe vazhdo");
        driver.FindElement(By.Name("chassisNr")).SendKeys("WAUZZZ4G4EN070522");
        driver.FindElement(By.Name("plate")).SendKeys("AB770PP");
