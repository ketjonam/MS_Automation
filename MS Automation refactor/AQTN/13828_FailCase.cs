...
/// <summary>
/// Stimulon rastin e FAIL të 13828: të njëjtat të dhëna, por pa ngarkuar dokumente,
/// që pas Dërgo të mos shfaqet as sukses as "Kujdes". Testi dështon me mesazhin e UI.
/// </summary>
[TestFixture]
public class _13828_FailCase_
{
    ...
    [Test]
    public void PlaniRregulluesFshati_FailCase_ReturnsUiMessage()
    {
        ...
        Log("Fill form (të njëjtat të dhëna si 13828)");
        driver.FindElement(By.Id("Nid")).SendKeys("J55728107R");
        driver.FindElement(By.Id("ServiceCode")).SendKeys("13828");
        ...
        IWebElement Shtetesia = wait.Until(ExpectedConditions.ElementIsVisible(By.Name("shtetesia")));
        ...
        IWebElement RequiredError = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div[2]/div/form/div/div[5]/div")));
        Assert.That(RequiredError.Text.Trim(), Is.EqualTo("Plotësoni fushën për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        driver.FindElement(By.Name("formatiHartes")).SendKeys("1");
        driver.FindElement(By.Name("vitiHartes")).SendKeys("1");
        driver.FindElement(By.Name("specifikimi")).SendKeys("1");
        driver.FindElement(By.Name("qytetiHartes")).SendKeys("test");
        driver.FindElement(By.Name("rugaZona")).SendKeys("test");
        ...
        IWebElement Step3Title = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div[2]/div/div[2]/div[1]/div/h4")));
