...
public class _9779_
{
    ...
    public void VertetimKonsullorIdentiteti()
    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("9779");
        ...
        IWebElement msgErrorReqField = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[5]/div")));
        Assert.That(msgErrorReqField.Text.Trim(), Is.EqualTo("Plotësoni fushën për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.Id("bashkiaCode"))).SelectByValue("2");
        driver.FindElement(By.Id("cityCode")).SendKeys("test");
        driver.FindElement(By.Id("streetAndNumber")).SendKeys("test");
        driver.FindElement(By.Id("postalCodeId")).SendKeys("1001");
        ...
        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.Id("country"))).SelectByValue("Emiratet e Bashkuara Arabe");
        Thread.Sleep(500);
        ...
        Log("Ploteso fushat e detyrueshme");
        driver.FindElement(By.Id("emriVi")).SendKeys("test");
        driver.FindElement(By.Id("mbiemriVi")).SendKeys("test");
        driver.FindElement(By.Id("atesiaVi")).SendKeys("test");
        driver.FindElement(By.Id("amesiaVi")).SendKeys("test");
        driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[5]/div/input")).SendKeys("01.01.1995");    
        driver.FindElement(By.Id("vendlindjaQytetiVi")).SendKeys("test");
        new SelectElement(driver.FindElement(By.Id("vendlindjaShtetiVi"))).SelectByValue("1");
        driver.FindElement(By.Id("vendbanimiVi")).SendKeys("test");
        new SelectElement(driver.FindElement(By.Id("gjiniaVi"))).SelectByValue("0");
        new SelectElement(driver.FindElement(By.Id("gjendjaCivileVi"))).SelectByValue("1");
        driver.FindElement(By.Id("shtetesiaVi")).SendKeys("test");
        driver.FindElement(By.Id("nidVi")).SendKeys("test");
        ...
        IWebElement msgErrorDocs = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div[1]/div/div[2]/div[2]")));
        ...
        string Fotografi = @"C:\Users\Kreatx\Downloads\Signed_TEST_signed.pdf";
        ...
        IWebElement FotografiInput = wait.Until(
         ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Fotografi')]/following::input[@type='file'][1]"))
        );
