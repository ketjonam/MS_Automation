...
public class _9775_
{
    ...
    [Test]
    public void VertetimKonsullorINdryshem()
    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("9775");
        ...
        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[1]/select"))).SelectByText("Emiratet e Bashkuara Arabe");
        ...
        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[3]/select"))).SelectByText("Emiratet e Bashkuara Arabe");
        Thread.Sleep(500);
        ...
        Assert.That(Step4Title.Text.Trim(), Is.EqualTo("KËRKESA PËR VËRTETIM *"));

        Log("Kliko Vazhdo button pa plotesuar fushat e detyrueshme");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/button[2]"));

        Log("Assert mesazhin e errorit per fushat e detyrueshme");
        IWebElement msgErrorHsb = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div/span")));
        Assert.That(msgErrorHsb.Text.Trim(), Is.EqualTo("Plotësoni fushën për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div/textarea")).SendKeys("test");
