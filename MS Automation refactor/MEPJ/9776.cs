...
public class _9776_
{
    ...
    public void RegjistrimMarteseMeShtetasShqiptar()
    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("9776");
        ...
        IWebElement msgError = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[7]/div")));
        Assert.That(msgError.Text.Trim(), Is.EqualTo("Përzgjidhni një vlerë për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.Id("state"))).SelectByValue("1");
        ...
        IWebElement msgErrorReqField = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[3]/div")));
        ...
        Log("Assert mesazhin e errorit per fushat e detyrueshme");
        IWebElement msgErrorContact = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[3]/div")));
        ...
        new SelectElement(driver.FindElement(By.Name("shteti"))).SelectByValue("2");
        Thread.Sleep(500);
        new SelectElement(driver.FindElement(By.Name("konsullataShteti"))).SelectByValue("1");
        ...
        Log("Assert mesazhin e errorit per fushat e detyrueshme");
        IWebElement msgErrorHsb = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[7]/div")));
        ...
        driver.FindElement(By.Id("nid")).SendKeys("J55728107R");
        driver.FindElement(By.Id("motherName")).SendKeys("test");
        driver.FindElement(By.Id("fatherName")).SendKeys("test");
        ...
        new SelectElement(driver.FindElement(By.Id("civilStatus"))).SelectByValue("3");
        driver.FindElement(By.Id("nationality")).SendKeys("test");
        driver.FindElement(By.Id("citizenship")).SendKeys("test");
        driver.FindElement(By.Id("residence")).SendKeys("test");
        driver.FindElement(By.Id("domicile")).SendKeys("test");
        ...
        Log("Assert mesazhin e errorit per fushat e detyrueshme");
        IWebElement msgErrorMarriage = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[1]/div")));
        Assert.That(msgErrorMarriage.Text.Trim(), Is.EqualTo("Plotësoni fushën për të vazhduar"));


        Log("Ploteso fushat e detyrueshme");
        driver.FindElement(By.Id("deshmitari1Emri")).SendKeys("test");
        driver.FindElement(By.Id("deshmitari1Mbiemri")).SendKeys("test");
        driver.FindElement(By.Id("deshmitari1NID")).SendKeys("test");
        driver.FindElement(By.Id("deshmitari2Emri")).SendKeys("test");
        driver.FindElement(By.Id("deshmitari2Mbiemri")).SendKeys("test");
        driver.FindElement(By.Id("deshmitari2NID")).SendKeys("test");      
        ...
        //IWebElement Step7Title = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/h4")));
        ...
        IWebElement msgErrorDocs = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div[1]/div[3]/div[2]")));
        Assert.That(msgErrorDocs.Text.Trim(), Is.EqualTo("Ju lutem ngarkoni dokumentin e kërkuar."));

        Log("Ngarko dokument jo te sakte");
        string DokumentID = @"C:\Users\Kreatx\Downloads\Kthim Alfis test(1).pdf";
        string LejeQendrimi = @"C:\Users\Kreatx\Downloads\Test_Automation_NIPTWEB_Prezantim.pptx";
        string IDDeshmitareve = @"C:\Users\Kreatx\Downloads\E88.30_CheckPointVPN.msi";


        Assert.That(File.Exists(DokumentID), Is.True, "File DokumentID nuk ekziston.");
        Assert.That(File.Exists(LejeQendrimi), Is.True, "File LejeQendrimi nuk ekziston.");
        Assert.That(File.Exists(IDDeshmitareve), Is.True, "File ID Deshmitareve nuk ekziston.");

        IWebElement DokumentIDInputWrong = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokument identifikimi')]/following::input[@type='file'][1]"))
        );
        DokumentIDInputWrong.SendKeys(DokumentID);

        IWebElement LejeQendrimiInputWrong = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Leje qëndrimi')]/following::input[@type='file'][1]"))
        );
        LejeQendrimiInputWrong.SendKeys(LejeQendrimi);

        IWebElement IDDeshmitareveInputWrong = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokument identifikimi për dëshmitarët')]/following::input[@type='file'][1]"))
        );
        IDDeshmitareveInputWrong.SendKeys(IDDeshmitareve);
        ...
        DokumentID = @"C:\Users\Kreatx\Downloads\Signed_TEST_signed.pdf";
        LejeQendrimi = @"C:\Users\Kreatx\Downloads\Signed_TEST_signed.pdf";
        IDDeshmitareve = @"C:\Users\Kreatx\Downloads\Signed_TEST_signed.pdf";

        Assert.That(File.Exists(DokumentID), Is.True, "File Dokument ID nuk ekziston.");
        Assert.That(File.Exists(LejeQendrimi), Is.True, "File Leje Qëndrimi nuk ekziston.");
        Assert.That(File.Exists(IDDeshmitareve), Is.True, "File ID Deshmitareve nuk ekziston.");

        IWebElement DokumentIDInput = wait.Until(
         ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokument identifikimi')]/following::input[@type='file'][1]"))
       );
        DokumentIDInput.SendKeys(DokumentID);

        IWebElement LejeQendrimiInput = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Leje qëndrimi')]/following::input[@type='file'][1]"))
        );
        LejeQendrimiInput.SendKeys(LejeQendrimi);

        IWebElement IDDeshmitareveInput = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokument identifikimi për dëshmitarët')]/following::input[@type='file'][1]"))
        );
        IDDeshmitareveInput.SendKeys(IDDeshmitareve);
