...
public class _9487_
{
    ...
    public void VertetimKonsullore_MEPJ_9487()
    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("9487");
        ...
        IWebElement msgErrorReqField = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[2]/div/small")));
        ...
        Assert.That(Step3Title.Text.Trim(), Is.EqualTo("GJENERALITETI I DOKUMENTIT 1"));

        Log("Kliko Vazhdo button pa plotesuar fushat e detyrueshme");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[3]/div/button[2]"));

        Log("Assert mesazhin e errorit per fushat e detyrueshme");
        IWebElement msgErrorDoc = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[1]/div/small")));
        Assert.That(msgErrorDoc.Text.Trim(), Is.EqualTo("Plotësoni fushën për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        driver.FindElement(By.Id("emri")).SendKeys("test");
        driver.FindElement(By.Id("mbiemri")).SendKeys("test");
        new SelectElement(driver.FindElement(By.Id("vendlindjaShteti"))).SelectByValue("1");
        driver.FindElement(By.Id("qyteti")).SendKeys("test");
        driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[5]/div[1]/input")).SendKeys("10.04.2026");
        new SelectElement(driver.FindElement(By.Id("gjinia"))).SelectByValue("F");
        driver.FindElement(By.Id("nID")).SendKeys("test");
        ...
        Assert.That(Step4Title.Text.Trim(), Is.EqualTo("GJENERALITETI I DOKUMENTIT 2"));

        Log("Kliko Vazhdo button pa plotesuar fushat e detyrueshme");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[3]/div/button[2]"));

        Log("Assert mesazhin e errorit per fushat e detyrueshme");
        IWebElement msgErrorDoc1 = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[2]/div/small")));
        Assert.That(msgErrorDoc1.Text.Trim(), Is.EqualTo("Plotësoni fushën për të vazhduar"));
        ...
        Assert.That(Step5Title.Text.Trim(), Is.EqualTo("GJENERALITETI I DOKUMENTIT 3"));
        ...
        Assert.That(Step6Title.Text.Trim(), Is.EqualTo("GJENERALITETET E SAKTA"));

        Log("Kliko Vazhdo button pa plotesuar fushat e detyrueshme");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[3]/div/button[2]"));

        Log("Assert mesazhin e errorit per fushat e detyrueshme");
        IWebElement msgErrorCorrectDoc = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[2]/div/small")));
        Assert.That(msgErrorCorrectDoc.Text.Trim(), Is.EqualTo("Plotësoni fushën për të vazhduar"));
        ...
        Assert.That(Step7Title.Text.Trim(), Is.EqualTo("KONTAKTI"));
        ...
        new SelectElement(driver.FindElement(By.Id("vendlindjaShteti"))).SelectByValue("2");
        Thread.Sleep(500);
        new SelectElement(driver.FindElement(By.Id("konsullataShteti"))).SelectByValue("1");
        ...
        Log("Assert Step8 title");
        IWebElement Step8Title = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/h2")));
        Assert.That(Step8Title.Text.Trim(), Is.EqualTo("Dokumentacioni"));
        ...
        string Doc1 = @"C:\Users\Kreatx\Downloads\Kthim Alfis test(1).pdf";
        string Doc2 = @"C:\Users\Kreatx\Downloads\TEST.pdf";

        Assert.That(File.Exists(Doc1), Is.True, "File Doc1 nuk ekziston.");
        Assert.That(File.Exists(Doc2), Is.True, "File Doc2 nuk ekziston.");

        IWebElement Doc1InputWrong = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokumenti 1')]/following::input[@type='file'][1]"))
        );
        Doc1InputWrong.SendKeys(Doc1);
        ...
        Doc1 = @"C:\Users\Kreatx\Downloads\Signed_TEST_signed.pdf";
        Doc2 = @"C:\Users\Kreatx\Downloads\Signed_TEST_signed.pdf";

        Assert.That(File.Exists(Doc1), Is.True, "File Doc1 nuk ekziston.");

        IWebElement Doc1Input = wait.Until(
         ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokumenti 1')]/following::input[@type='file'][1]"))
       );
        Doc1Input.SendKeys(Doc1);

        IWebElement Doc2Input = wait.Until(
         ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokumenti 2')]/following::input[@type='file'][1]"))
       );
        Doc2Input.SendKeys(Doc2);
