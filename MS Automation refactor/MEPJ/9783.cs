...
public class _9783_
{
    ...
    public void AplikimPerProkureTePosacme()
    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("9783");
        ...
        IWebElement msgError = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[2]/div")));
        Assert.That(msgError.Text.Trim(), Is.EqualTo("Përzgjidhni një vlerë për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.Id("tipiProkures"))).SelectByValue("2");
        ...
        Assert.That(Step3Title.Text.Trim(), Is.EqualTo("TË DHËNA TË PËRFAQËSUESIT TË POSAÇËM"));

        Log("Kliko Vazhdo button pa plotesuar fushat e detyrueshme");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/button[2]"));

        Log("Assert mesazhin e errorit per fushat e detyrueshme");
        IWebElement msgErrorPrf = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[4]/div")));
        Assert.That(msgErrorPrf.Text.Trim(), Is.EqualTo("Plotësoni fushën për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        driver.FindElement(By.Id("firstName")).SendKeys("test");
        driver.FindElement(By.Id("lastName")).SendKeys("test");
        driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[3]/div/input")).SendKeys("01.01.1990");
        driver.FindElement(By.Id("placeOfBirth")).SendKeys("test");
        driver.FindElement(By.Id("idNumber")).SendKeys("test");
        new SelectElement(driver.FindElement(By.Id("gender"))).SelectByValue("F");
        ...
        Assert.That(Step4Title.Text.Trim(), Is.EqualTo("KONTAKTI"));
        ...
        Thread.Sleep(500);
        new SelectElement(driver.FindElement(By.Id("consulateOffice"))).SelectByValue("12");
        ...
        Assert.That(Step5Title.Text.Trim(), Is.EqualTo("KËRKESA PËR LËSHIMIN E PROKURËS*"));

        Log("Kliko Vazhdo button pa plotesuar fushat e detyrueshme");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/button[2]"));

        Log("Assert mesazhin e errorit per fushat e detyrueshme");
        IWebElement msgErrorHsb = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div/div")));
        Assert.That(msgErrorHsb.Text.Trim(), Is.EqualTo("Plotësoni fushën për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        driver.FindElement(By.Id("requestData")).SendKeys("test");
        ...
        IWebElement Step6Title = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/h2")));
