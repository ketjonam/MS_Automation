...
public class _9803_
{
    ...
    public void AplikimPerVertetimCertifikateFamiljare()
    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("9803");
        ...
        Assert.That(step1Title.Text.Trim(), Is.EqualTo("TË DHËNAT PERSONALE TË APLIKANTIT"));
        Thread.Sleep(1000);
        ...
        IWebElement msgError = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[9]/div/small")));
        Assert.That(msgError.Text.Trim(), Is.EqualTo("Përzgjidhni një vlerë për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.Id("vendlindjaShteti"))).SelectByValue("1");
        ...
        IWebElement msgErrorReqField = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[4]/div/small")));
        Assert.That(msgErrorReqField.Text.Trim(), Is.EqualTo("Plotësoni fushën për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.Id("vendlindjaShteti"))).SelectByValue("2");
        driver.FindElement(By.Id("street")).SendKeys("test");
        driver.FindElement(By.Id("city")).SendKeys("test");
        driver.FindElement(By.Id("postalCode")).SendKeys("1001");
        ...
        Log("Assert mesazhin e errorit per fushat e detyrueshme");
        IWebElement msgErrorContact = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[3]/div/small")));
        ...
        Log("Ploteso fushat e detyrueshme");
        new SelectElement(driver.FindElement(By.Id("vendlindjaShteti"))).SelectByValue("59");
        Thread.Sleep(500);
        new SelectElement(driver.FindElement(By.Id("konsullataShteti"))).SelectByValue("12");
        ...
        Assert.That(Step4Title.Text.Trim(), Is.EqualTo("PËRBËRJA FAMILJARE"));

        Log("Kliko Vazhdo button pa plotesuar fushat e detyrueshme");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[3]/div/button[2]"));

        Log("Assert mesazhin e errorit per fushat e detyrueshme");
        IWebElement msgErrorFamily = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[2]")));
        Assert.That(msgErrorFamily.Text.Trim(), Is.EqualTo("Ju duhet të shtoni të paktën një pjesëtar të familjes për të vazhduar."));

        Log("Kliko butonin Shto familjar");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/button"));

        Log("Assert titullin e modalit shto familjar");
        IWebElement ModalTitle = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[3]/div/div[1]/h2")));
        Assert.That(ModalTitle.Text.Trim(), Is.EqualTo("Shto pjesëtar të familjes"));  

        Log("Ploteso te dhenat e familjarit");
        driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div/div[1]/div/input")).SendKeys("test");
        driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div/div[2]/div/input")).SendKeys("test");
        driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div/div[3]/div/input")).SendKeys("test");
        driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div/div[4]/div/input")).SendKeys("test");
        driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div/div[5]/div/div/input")).SendKeys("04.05.2026");
        new SelectElement(driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div/div[6]/div/select"))).SelectByValue("1");
        driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div/div[7]/div/input")).SendKeys("test");
        driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div/div[8]/div/input")).SendKeys("test");
        new SelectElement(driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div/div[9]/div/select"))).SelectByValue("f");
        new SelectElement(driver.FindElement(By.XPath("//html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div/div[10]/div/select"))).SelectByValue("i/e pacaktuar");
        driver.FindElement(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div/div[11]/div/input")).SendKeys("test");

        Log("Kliko Ruaj");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div[3]/div/div[3]/button[2]"));

        Thread.Sleep(500);

        Log("Assert se familjari u shtua ne listen e familjareve");
        IWebElement AddedFamilyMember = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div/div/table/tbody/tr")));
        ...
        //IWebElement Step5Title = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/h2")));
        //Assert.That(Step5Title.Text.Trim(), Is.EqualTo("Dokumentacioni"));


        Log("Ngarko dokument jo te sakte");
        string Dokumenti = @"C:\Users\Kreatx\Downloads\Kthim Alfis test(1).pdf";

        Assert.That(File.Exists(Dokumenti), Is.True, "File Dokumenti nuk ekziston.");

        IWebElement DokumentiInputWrong = wait.Until(
          ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokument identifikimi')]/following::input[@type='file'][1]"))
        );
        DokumentiInputWrong.SendKeys(Dokumenti);
        ...
        Dokumenti = @"C:\Users\Kreatx\Downloads\Signed_TEST_signed.pdf";

        Assert.That(File.Exists(Dokumenti), Is.True, "File Dokumenti nuk ekziston.");

        IWebElement DokumentiInput = wait.Until(
         ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Dokument identifikimi')]/following::input[@type='file'][1]"))
       );
        DokumentiInput.SendKeys(Dokumenti);

        Log("Kliko checkboxin");
