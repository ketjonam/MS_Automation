...
public class _368_
{
    ...
    public void PensionetePaterhequra()
    {
        ...
        Assert.That(Step1Title.Text.Trim(), Is.EqualTo("PENSIONET"));


        Log("Assert pensionet e paterhequra");
        IWebElement Emri = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div[2]/table/tbody/tr[1]/td[1]")));
        Assert.That(Emri.Text.Trim(), Is.EqualTo("MERSIN MUSTAFA MEMA"));

        IWebElement Qyteti = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div[2]/table/tbody/tr[1]/td[2]")));
        Assert.That(Qyteti.Text.Trim(), Is.EqualTo("KAVAJË"));

        IWebElement NrFature = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div[2]/table/tbody/tr[1]/td[3]")));
        Assert.That(NrFature.Text.Trim(), Is.EqualTo("115215921"));


        Log("Kerko me te dhena jo te sakta");
        IWebElement searchInput = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div[1]/div/div/input")));
        searchInput.SendKeys("test");   

        Log("Assert no results");
        IWebElement noResults = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div[2]/table/tbody/tr/td")));
