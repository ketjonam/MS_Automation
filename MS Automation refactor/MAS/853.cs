...
public class _853_
{
    ...
    [Test]
    public void NjehesimiDiplomave()
    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("853");
        ...
        Assert.That(step1Title.Text.Trim(), Is.EqualTo("SHTETËSIA"));

        Log("Kliko Vazhdo button pa zgjedhur shtetesine");
        ...
        IWebElement msgError = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div/div[2]")));
        Assert.That(msgError.Text.Trim(), Is.EqualTo("Përzgjidhni një vlerë për të vazhduar"));

        Log("Zgjidh shtetesine");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div/div[1]/div/div[2]/input"));
        ...
        IWebElement Tel = wait.Until(ExpectedConditions.ElementIsVisible(By.Name("celNo")));
        ...
        Log("Assert mesazhin per fushat e detyrueshme");
        IWebElement msgErrorReqField = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/form/div/div[1]/div[2]")));
        Assert.That(msgErrorReqField.Text.Trim(), Is.EqualTo("Përzgjidhni një vlerë për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        SafeClick(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/form/div/div[1]/div[1]/div[2]/div[3]/input"));
        driver.FindElement(By.Name("degreeName")).SendKeys("Test");
        driver.FindElement(By.Name("universityName")).SendKeys("Test");
        driver.FindElement(By.Name("enrollmentDate")).SendKeys("01.01.2020");
        driver.FindElement(By.Name("graduationDate")).SendKeys("01.01.2021");
        driver.FindElement(By.Name("legalDuration")).SendKeys("2"); 
        driver.FindElement(By.Name("semesters")).SendKeys("4");
        SafeClick(By.Name("admissionReq"));
        SafeClick(By.Name("studyLevelAfter"));
        driver.FindElement(By.Name("universityEmail")).SendKeys("Master@test.com");
        ...
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[4]/button[2]"));

        Log("Assert mesazhin per dokumentet e detyrueshme");
        IWebElement msgErrorDoc = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div[1]/div[1]/div[2]")));
        Assert.That(msgErrorDoc.Text.Trim(), Is.EqualTo("Ju lutemi ngarkoni dokumentin e kërkuar"));

        Log("Ngarko dokument jo te sakte");
        string Diploma = @"C:\Users\Kreatx\Downloads\Kthim Alfis test(1).pdf";
        string ListeNotash = @"C:\Users\Kreatx\Downloads\Kthim Alfis test(1).pdf";

        Assert.That(File.Exists(Diploma), Is.True, "File Diploma nuk ekziston.");

        IWebElement DiplomaInputWrong = wait.Until(
          ExpectedConditions.ElementExists(
              By.XPath("//div[contains(.,'Diplomën / certifikatën')]/following::input[@type='file'][1]"))
        );
        ...
        Diploma = @"C:\Users\Kreatx\Downloads\Signed_TEST_signed.pdf";
        ListeNotash = @"C:\Users\Kreatx\Downloads\Signed_TEST_signed.pdf";

        Assert.That(File.Exists(Diploma), Is.True, "File Diploma nuk ekziston.");
        Assert.That(File.Exists(ListeNotash), Is.True, "File ListeNotash nuk ekziston.");
        ...
        IWebElement ListeNotashInput = wait.Until(
         ExpectedConditions.ElementExists(
             By.XPath("//div[contains(.,'Listën e notave')]/following::input[@type='file'][1]"))
       );
        ListeNotashInput.SendKeys(ListeNotash); 

        Log("Kliko checkbox ");
        SafeClick(By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div[4]/div[2]/span"));
