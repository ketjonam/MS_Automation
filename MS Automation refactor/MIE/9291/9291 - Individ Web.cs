    ...
    public void Aplikim_i_Ri_9291()
    {
        ...
        using (IWebDriver driver = new EdgeDriver(options))
        {
            ...
            try
            {
                ...
                driver.FindElement(By.Id("ServiceCode")).SendKeys("9291");
...
qarku
                ...
                IWebElement docErrorMessage = wait.Until(
                    ExpectedConditions.ElementIsVisible(
                        By.XPath("/html/body/div/main/div[3]/div/div/div/div/div[2]/div[2]/div/div[2]"))
                );
                ...
                IWebElement vetedeklarimiInputWrong = wait.Until(
                    ExpectedConditions.ElementExists(
                        By.XPath("//div[contains(.,'Vetëdeklarimi')]/following::input[@type='file'][1]"))
                );
