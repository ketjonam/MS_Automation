...
public class _13789_
{
...

    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("13789");
        ...
        Log("Kliko Vazhdo pa zgjedhur Qarkun e Aplikimit");
        ...
        IWebElement Bashkia = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[10]/input")));
