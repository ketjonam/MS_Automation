...
public class _13785_
{
...

    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("13785");
        ...
        IWebElement Atesia = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[3]/input")));
        Assert.That(Atesia.GetAttribute("value").Trim(), Is.EqualTo("Mersin"));

        IWebElement Mbiemri = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[2]/input")));
        ...
        IWebElement Qyteti = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[9]/input")));
        Assert.That(Qyteti.GetAttribute("value").Trim(), Is.EqualTo("TIRANË"));

        IWebElement Rrethi = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[10]/input")));
        Assert.That(Rrethi.GetAttribute("value").Trim(), Is.EqualTo("KAVAJË"));

        IWebElement Tel = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[12]/input")));
        Assert.That(Tel.GetAttribute("value").Trim(), Is.EqualTo("0676041404"));

        IWebElement Email = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[11]/input")));
        Assert.That(Email.GetAttribute("value").Trim(), Is.EqualTo("ketjona.mema@kreatx.com"));

        new SelectElement(wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div/main/div[3]/div/div/div/div/form/div/div[15]/select")))).SelectByValue("Tiranë");
        ...
        string Fotografi = @"C:\Users\Kreatx\Downloads\Zones Report.xlsx";
        string Mandatpagesa = @"C:\Users\Kreatx\Downloads\15mb.pdf";

        Assert.That(File.Exists(Fotokopje), Is.True, "File Fotokopje nuk ekziston.");

        IWebElement FotokopjeInputWrong = wait.Until(
            ExpectedConditions.ElementExists(
                By.XPath("//div[contains(.,'Fotokopje e Lejes së Drejtimit')]/following::input[@type='file'][1]"))
        );
        ...
        Assert.That(
            fileTypeError.Text.Trim(),
            Does.Contain("Formati duhet të jetë: PDF")
        );
        ...
        Fotokopje = signedPdfPath;
        Fotografi = signedPdfPath;
        Mandatpagesa = signedPdfPath;
