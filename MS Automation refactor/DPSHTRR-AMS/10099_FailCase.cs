...
/// <summary>
/// Stimulon rastin e FAIL të 10099: motivi unik, pa ngarkuar dokumente.
/// Pas Dërgo pret Fail me mesazhin e UI (as sukses, as "Kujdes").
/// </summary>
[TestFixture]
public class _10099_FailCase_
{
    ...
    [Test]
    public void LejeDrejtimiNderkombetare_FailCase_ReturnsUiMessage()
    {
        ...
        Log("Fill form (të njëjtat të dhëna si 10099)");
        ...
        Log("Ploteso fushat e detyrueshme me motiv unik");
        new SelectElement(wait.Until(ExpectedConditions.ElementIsVisible(By.Id("drejtoriaRajionale"))))
            .SelectByValue("Tiranë");

        string uniqueMotivi = "FAIL99-" + DateTime.Now.ToString("yyyyMMddHHmmss");
        Log("Motivi unik për stimulim FAIL: " + uniqueMotivi);
        driver.FindElement(By.Id("motivi")).SendKeys(uniqueMotivi);
