...
public class _10099_
{
    ...
    private string ReadVisibleMainTitle()
    {
        foreach (var by in new[]
        {
            By.XPath("//main//h5"),
            By.XPath("//main//h4"),
            By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/h5"),
            By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/h4")
        })
        {
            try
            {
    ...
    [Test]
    public void LejeDrejtimiNderkombetare()

    {
        ...
        driver.FindElement(By.Id("ServiceCode")).SendKeys("10099");
        ...
        IWebElement Step1Title = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/h5")));
        ...
        IWebElement Qyteti = wait.Until(ExpectedConditions.ElementIsVisible(By.Name("qyteti")));
        Assert.That(Qyteti.GetAttribute("value").Trim(), Is.EqualTo("KAVAJË"));

        IWebElement Tel = wait.Until(ExpectedConditions.ElementIsVisible(By.Name("nrCel")));
        ...
        IWebElement msgErrorMsg = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html/body/div[1]/main/div[3]/div/div/div/div/form/div/div[1]/span")));
        Assert.That(msgErrorMsg.Text.Trim(), Is.EqualTo("Përzgjidhni një vlerë për të vazhduar"));

        Log("Ploteso fushat e detyrueshme");
        new SelectElement(wait.Until(ExpectedConditions.ElementIsVisible(By.Id("drejtoriaRajionale")))).SelectByValue("Tiranë");

        Log("Assert detajet e lejes se drejtimit");
        IWebElement NrLejesDrejtimit = wait.Until(ExpectedConditions.ElementIsVisible(By.Name("nrLejedrejtimi")));  
        ...
        Log("Ploteso motivin e kerkeses");
        driver.FindElement(By.Id("motivi")).SendKeys("Test");
        ...
        Log("Titulli pas Step3: '" + afterStep3Title + "'");
        ...
        else
        {
            ...
            {
                Assert.Fail("Pas Step3 nuk u gjet as DOKUMENTACIONI as butoni Dërgo: " + ex.Message);
            }
        }
