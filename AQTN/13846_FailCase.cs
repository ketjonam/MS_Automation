...
/// <summary>
/// Stimulon rastin e FAIL të 13846: të njëjtat të dhëna, por pa ngarkuar dokumente,
/// që pas Dërgo të mos shfaqet as sukses as "Kujdes". Testi dështon me mesazhin e UI.
/// </summary>
[TestFixture]
public class _13846_FailCase_
{
    ...
    [Test]
    public void FleteProjektiTip_FailCase_ReturnsUiMessage()
    {
        ...
        Log("Fill form (të njëjtat të dhëna si 13846)");
        driver.FindElement(By.Id("Nid")).SendKeys("J55728107R");
        driver.FindElement(By.Id("ServiceCode")).SendKeys("13846");
