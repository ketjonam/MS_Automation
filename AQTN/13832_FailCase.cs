...
/// <summary>
/// Stimulon rastin e FAIL të 13832: të njëjtat të dhëna, por pa ngarkuar dokumente,
/// që pas Dërgo të mos shfaqet as sukses as "Kujdes". Testi dështon me mesazhin e UI.
/// </summary>
[TestFixture]
public class _13832_FailCase_
{
    ...
    [Test]
    public void Projekteve_Ujesjellesve_Kanalizimeve_FailCase_ReturnsUiMessage()
    {
        ...
        Log("Fill form (të njëjtat të dhëna si 13832)");
        driver.FindElement(By.Id("Nid")).SendKeys("J55728107R");
        driver.FindElement(By.Id("ServiceCode")).SendKeys("13832");
